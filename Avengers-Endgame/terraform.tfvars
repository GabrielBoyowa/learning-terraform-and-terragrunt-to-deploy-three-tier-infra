...
alb_log_bucket = "alb-access-log-spiderman-north-virginia"


aws-waf-logs-CDN-bucket-DESTINATION = "aws-waf-logs-cdn-destination-ultron"


cloud_front_origin_bucket = "aws-cloudfront-origin-bucket-loki-north-virginia"